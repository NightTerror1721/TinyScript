...
public class Arguments extends Statement implements Iterable<Statement>
{
    ...
    public static final Arguments valueOf(String... args) throws CompilerError
    {
        Statement[] sargs = new Statement[args.length];
        for(int i=0;i<args.length;i++)
            sargs[i] = Identifier.valueOf(args[i]);
        return new Arguments(sargs);
    }
