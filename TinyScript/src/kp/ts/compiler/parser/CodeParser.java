...
import kp.ts.compiler.exception.ErrorList;
            ...
            for(;;)
            {
                ...
                switch(c)
                {
                    ...
                    case '(': {
                        ...
                        {
                            accumulated.enqret(StatementParser.parse(list));
                        }
    ...
    private static final class CodeFragmentBuilder
    {
        ...
        public final CodeFragment decode() throws CompilerError
        {
            ...
            switch(str = sb.toString())
            {
                ...
                case "self": return SpecialIdentifier.SELF;
                case "base": return SpecialIdentifier.BASE;
                case "iterator": return SpecialIdentifier.ITERATOR;
                case "number": return SpecialIdentifier.NUMBER;
                case "boolean": return SpecialIdentifier.BOOLEAN;
                case "string": return SpecialIdentifier.STRING;
                case "array": return SpecialIdentifier.ARRAY;
                case "object": return SpecialIdentifier.OBJECT;
